...
// Ambil data jenis pesanan dan jumlahnya berdasarkan tanggal
$query_jenis_pesanan = "SELECT jenis_pesanan, COUNT(*) as jumlah FROM pemesanan WHERE tanggal = '$tanggal_terpilih' GROUP BY jenis_pesanan";
...
?>
                                    ...
                                    <div class="card-body pb-0">
                                        <h5 class="card-title">Jumlah Pesanan per Jenis pada
                                            <?php echo $tanggal_terpilih; ?></h5>
...
// Query untuk menghitung total harga semua pesanan pada tanggal tersebut
...
<h2>Laporan Pemesanan pada <?php echo $tanggal_terpilih; ?></h2>
...
<table class="table table-borderless datatable">
    ...
    <!-- Menampilkan Total Harga Semua Pesanan pada Tanggal Tersebut -->
    <tr>
