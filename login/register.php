                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" method="post" action="proses_registrasi.php" enctype="multipart/form-data">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="password" class="form-control" id="yourName" required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="date" name="ttl" class="form-control" id="yourName" required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="no_hp" class="form-control" id="yourName" required>
